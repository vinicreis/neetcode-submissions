class Solution {
    ...
    private fun backtracking(board: Array<CharArray>, word: String): Boolean {
        ...
        fun backtracking(
            ...
            j: Int = 0,
            n: Int = 0,
            visited: Array<BooleanArray> = Array(board.size) { BooleanArray(board[it].size) },
        ): Boolean {
            ...
            return backtracking(i, j - 1, n + 1, visited)
                || backtracking(i - 1, j, n + 1, visited)
                || backtracking(i, j + 1, n + 1, visited)
                || backtracking(i + 1, j, n + 1, visited)
        }
